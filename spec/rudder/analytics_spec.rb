  ...
  class Analytics
    describe Analytics do
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of Rudder::Analytics::Client' do
          expect(analytics).to respond_to(*Rudder::Analytics::Client.public_instance_methods(false))
        end
      end
